...
subtitle: List of Software/Tools/Blogs and more we think are worth it!
...
[Vagrant](https://www.vagrantup.com/) Virtualization wrapper that helps to send virtual machine in minutes

[XAMPP](https://www.apachefriends.org/index.html) Quickest way to setup LAMP on windows

[Paint.net](https://www.getpaint.net/) Free powerful picture editing tool

### Online Tools

[https://www.json-generator.com](https://www.json-generator.com) :dummy data json generator

[https://jsoning.com/api/](https://jsoning.com/api/) : mock rest API
...
<https://pythonium.net/regex> : online visual regex editor: Python
...
[StackBlitz](https://stackblitz.com/) The online IDE for web applications.
...
[Formatting toggle](https://marketplace.visualstudio.com/items?itemName=tombonnike.vscode-status-bar-format-toggle) - A VS Code extension that allows you to toggle the formatting on and off with a simple click
